...
public class JiaoshiCommentbackView extends JiaoshiCommentbackEntity implements Serializable {
	...
	public JiaoshiCommentbackView() {

	}

	public JiaoshiCommentbackView(JiaoshiCommentbackEntity jiaoshiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, jiaoshiCommentbackEntity);
