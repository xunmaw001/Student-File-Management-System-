    ...
    */
    ...
    public R save(@RequestBody XueshengchengjiEntity xueshengchengji, HttpServletRequest request){
        ...
        Wrapper<XueshengchengjiEntity> queryWrapper = new EntityWrapper<XueshengchengjiEntity>()
            ...
            .eq("xueshengchengji_chengji", xueshengchengji.getXueshengchengjiChengji())
...
//                            xueshengchengjiEntity.setXueshengchengjiTypes(Integer.valueOf(data.get(0)));   //学科 要改的
//                            xueshengchengjiEntity.setXueshengchengjiChengji(Integer.valueOf(data.get(0)));   //成绩 要改的
