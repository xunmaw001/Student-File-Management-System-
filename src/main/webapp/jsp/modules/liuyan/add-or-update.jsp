    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑信息反馈</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">信息反馈管理</li>
                        <li class="breadcrumb-item active">编辑信息反馈</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">信息反馈信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6 liuyanTextDiv">
                                        <label>反馈内容</label>
                                        <textarea style="width: 450px"  id="liuyanText" name="liuyanText" class="form-control"placeholder="反馈内容"></textarea>
                                    </div>
