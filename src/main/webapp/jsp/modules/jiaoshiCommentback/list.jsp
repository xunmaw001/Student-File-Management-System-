...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">教评列表</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function getDataList() {
            http("jiaoshiCommentback/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                jiaoshiCommentbackDelete: 1,
                //本表的
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //评价内容
            var jiaoshiCommentbackTextCell = document.createElement('td');
            jiaoshiCommentbackTextCell.innerHTML = item.jiaoshiCommentbackText;
            row.appendChild(jiaoshiCommentbackTextCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jiaoshiCommentback/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjiaoshiCommentback", "addjiaoshiCommentback");
            window.location.href = "add-or-update.jsp"
        }
