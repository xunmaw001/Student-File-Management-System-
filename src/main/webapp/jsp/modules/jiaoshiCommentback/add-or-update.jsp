            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">教评管理</li>
                        <li class="breadcrumb-item active">编辑教评</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 jiaoshiCommentbackTextDiv">
                                        <label>评价内容</label>
                                        <textarea style="width: 450px"  id="jiaoshiCommentbackText" name="jiaoshiCommentbackText" class="form-control"placeholder="评价内容"></textarea>
                                    </div>
...
<script>
    ...
    var tableName = "jiaoshiCommentback";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("jiaoshiCommentback/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addjiaoshiCommentback');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                jiaoshiId: "required",
                yonghuId: "required",
                jiaoshiCommentbackText: "required",
                replyText: "required",
            },
            messages: {
                jiaoshiId: "教师不能为空",
                yonghuId: "学生不能为空",
                jiaoshiCommentbackText: "评价内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addjiaoshiCommentback = window.sessionStorage.getItem("addjiaoshiCommentback");
        if (addjiaoshiCommentback != null && addjiaoshiCommentback != "" && addjiaoshiCommentback != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("jiaoshiCommentback/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#jiaoshiCommentbackText").val(ruleForm.jiaoshiCommentbackText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#jiaoshiCommentbackText').attr('readonly', 'readonly');
