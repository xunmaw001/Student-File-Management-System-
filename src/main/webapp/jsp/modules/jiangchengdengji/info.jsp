            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">奖惩登记登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="jiaoshiId" name="jiaoshiId" v-model="ruleForm.jiaoshiId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiangchengdengjiName" name="jiangchengdengjiName" class="form-control"
                                               v-model="ruleForm.jiangchengdengjiName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>奖惩类型</label>
                                    <input style="width: 450px" id="jiangchengdengjiValue" name="jiangchengdengjiValue" class="form-control"
                                           v-model="ruleForm.jiangchengdengjiValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>详情</label>
                                        <input style="width: 450px" id="jiangchengdengjiText" name="jiangchengdengjiText" class="form-control"
                                               v-model="ruleForm.jiangchengdengjiText" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jiangchengdengji/info/" + id,
