...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">奖惩登记管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">奖惩登记列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">奖惩登记列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="jiangchengdengjiNameSearch" style="width: 140px;" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //标题
            var jiangchengdengjiNameSearchInput = $('#jiangchengdengjiNameSearch');
            if( jiangchengdengjiNameSearchInput != null){
                if (jiangchengdengjiNameSearchInput.val() != null && jiangchengdengjiNameSearchInput.val() != '') {
                    searchForm.jiangchengdengjiName = $('#jiangchengdengjiNameSearch').val();
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("jiangchengdengji/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                jiangchengdengjiDelete: 1,
                //本表的
                jiangchengdengjiName: searchForm.jiangchengdengjiName,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //标题
            var jiangchengdengjiNameCell = document.createElement('td');
            jiangchengdengjiNameCell.innerHTML = item.jiangchengdengjiName;
            row.appendChild(jiangchengdengjiNameCell);


            //奖惩类型
            var jiangchengdengjiTypesCell = document.createElement('td');
            jiangchengdengjiTypesCell.innerHTML = item.jiangchengdengjiValue;
            row.appendChild(jiangchengdengjiTypesCell);


            //详情
            var jiangchengdengjiTextCell = document.createElement('td');
            jiangchengdengjiTextCell.innerHTML = item.jiangchengdengjiText;
            row.appendChild(jiangchengdengjiTextCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jiangchengdengji/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjiangchengdengji", "addjiangchengdengji");
            window.location.href = "add-or-update.jsp"
        }
