...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="xueshengchengjiNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        学科
                                        <div class="layui-input-inline">
                                            <select name="xueshengchengjiTypesSelectSearch"  style="width: 150px;" id="xueshengchengjiTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 本表的级联字段表 -->
        var xueshengchengjiTypesOptions = [];
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //标题
            var xueshengchengjiNameSearchInput = $('#xueshengchengjiNameSearch');
            if( xueshengchengjiNameSearchInput != null){
                if (xueshengchengjiNameSearchInput.val() != null && xueshengchengjiNameSearchInput.val() != '') {
                    searchForm.xueshengchengjiName = $('#xueshengchengjiNameSearch').val();
                }
            }
     
                //学科
            var xueshengchengjiTypesSelectSearchInput = document.getElementById("xueshengchengjiTypesSelectSearch");
            if(xueshengchengjiTypesSelectSearchInput != null){
                var xueshengchengjiTypesIndex = xueshengchengjiTypesSelectSearchInput.selectedIndex;
                if( xueshengchengjiTypesIndex  != 0){
                    searchForm.xueshengchengjiTypes= document.getElementById("xueshengchengjiTypesSelectSearch").options[xueshengchengjiTypesIndex].value;
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("xueshengchengji/page", "GET", {
                ...
                //本表的
                xueshengchengjiName: searchForm.xueshengchengjiName,
                xueshengchengjiTypes: searchForm.xueshengchengjiTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //标题
            var xueshengchengjiNameCell = document.createElement('td');
            xueshengchengjiNameCell.innerHTML = item.xueshengchengjiName;
            row.appendChild(xueshengchengjiNameCell);


            //学科
            var xueshengchengjiTypesCell = document.createElement('td');
            xueshengchengjiTypesCell.innerHTML = item.xueshengchengjiValue;
            row.appendChild(xueshengchengjiTypesCell);


            //成绩
            var xueshengchengjiChengjiCell = document.createElement('td');
            xueshengchengjiChengjiCell.innerHTML = item.xueshengchengjiChengji;
            row.appendChild(xueshengchengjiChengjiCell);


            //详情
            var xueshengchengjiTextCell = document.createElement('td');
            xueshengchengjiTextCell.innerHTML = item.xueshengchengjiText;
            row.appendChild(xueshengchengjiTextCell);
    ...
    //填充本表搜索下拉框
        ...
        function xueshengchengjiTypesSelectSearch() {
            var xueshengchengjiTypesSelectSearch = document.getElementById('xueshengchengjiTypesSelectSearch');
            if(xueshengchengjiTypesSelectSearch != null) {
                xueshengchengjiTypesSelectSearch.add(new Option('-请选择-',''));
                if (xueshengchengjiTypesOptions != null && xueshengchengjiTypesOptions.length > 0){
                    for (var i = 0; i < xueshengchengjiTypesOptions.length; i++) {
                            xueshengchengjiTypesSelectSearch.add(new Option(xueshengchengjiTypesOptions[i].indexName,xueshengchengjiTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
            function xueshengchengjiTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueshengchengji_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        xueshengchengjiTypesOptions = res.data.list;
                    }
                });
            }
        ...
        //当前表的下拉框赋值
            ...
            xueshengchengjiTypesSelectSearch();
