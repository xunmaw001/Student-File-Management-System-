                                ...
                                <input id="jiaoshiId" name="jiaoshiId" v-model="ruleForm.jiaoshiId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xueshengchengjiName" name="xueshengchengjiName" class="form-control"
                                               v-model="ruleForm.xueshengchengjiName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>学科</label>
                                    <input style="width: 450px" id="xueshengchengjiValue" name="xueshengchengjiValue" class="form-control"
                                           v-model="ruleForm.xueshengchengjiValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>成绩</label>
                                        <input style="width: 450px" id="xueshengchengjiChengji" name="xueshengchengjiChengji" class="form-control"
                                               v-model="ruleForm.xueshengchengjiChengji" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>详情</label>
                                        <input style="width: 450px" id="xueshengchengjiText" name="xueshengchengjiText" class="form-control"
                                               v-model="ruleForm.xueshengchengjiText" readonly>
                                    </div>
