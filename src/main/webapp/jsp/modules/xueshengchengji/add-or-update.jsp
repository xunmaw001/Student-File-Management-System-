                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="jiaoshiId" name="jiaoshiId" type="hidden">
                                    <div class="form-group col-md-6 xueshengchengjiNameDiv">
                                        <label>标题</label>
                                        <input style="width: 450px" id="xueshengchengjiName" name="xueshengchengjiName" class="form-control"
                                               placeholder="标题">
                                    </div>
                                    <div class="form-group col-md-6 xueshengchengjiTypesDiv">
                                        <label>学科</label>
                                        <select style="width: 450px" id="xueshengchengjiTypesSelect" name="xueshengchengjiTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 xueshengchengjiChengjiDiv">
                                        <label>成绩</label>
                                        <input style="width: 450px" id="xueshengchengjiChengji" name="xueshengchengjiChengji" class="form-control"
                                               onchange="xueshengchengjiChengjiChickValue(this)"  placeholder="成绩">
                                    </div>

                                    <div class="form-group col-md-6 xueshengchengjiTextDiv">
                                        <label>详情</label>
                                        <textarea style="width: 450px"  id="xueshengchengjiText" name="xueshengchengjiText" class="form-control"placeholder="详情"></textarea>
                                    </div>
...
<script>
    ...
    // 初始化下拉框
    <!-- 初始化当前表的下拉框 -->
        function initializationXueshengchengjitypesSelect(){
            var xueshengchengjiTypesSelect = document.getElementById('xueshengchengjiTypesSelect');
            if(xueshengchengjiTypesSelect != null && xueshengchengjiTypesOptions != null  && xueshengchengjiTypesOptions.length > 0 ){
                for (var i = 0; i < xueshengchengjiTypesOptions.length; i++) {
                    xueshengchengjiTypesSelect.add(new Option(xueshengchengjiTypesOptions[i].indexName,xueshengchengjiTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(xueshengchengjiTypesSelect != null && xueshengchengjiTypesOptions != null  && xueshengchengjiTypesOptions.length > 0 ) {
            for (var i = 0; i < xueshengchengjiTypesOptions.length; i++) {
                if (xueshengchengjiTypesOptions[i].codeIndex == ruleForm.xueshengchengjiTypes) {//下拉框value对比,如果一致就赋值汉字
                        xueshengchengjiTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function xueshengchengjiChengjiChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                yonghuId: "required",
                jiaoshiId: "required",
                xueshengchengjiName: "required",
                xueshengchengjiTypes: "required",
                xueshengchengjiChengji: "required",
                xueshengchengjiText: "required",
            },
            messages: {
                yonghuId: "学生不能为空",
                jiaoshiId: "教师不能为空",
                xueshengchengjiName: "标题不能为空",
                xueshengchengjiTypes: "学科不能为空",
                xueshengchengjiChengji: "成绩不能为空",
                xueshengchengjiText: "详情不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#xueshengchengjiName").val(ruleForm.xueshengchengjiName);
        $("#xueshengchengjiChengji").val(ruleForm.xueshengchengjiChengji);
        $("#xueshengchengjiText").val(ruleForm.xueshengchengjiText);
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            <!--  初始化当前表的下拉框  -->
            initializationXueshengchengjitypesSelect();
            <!--  初始化级联表的下拉框  -->
