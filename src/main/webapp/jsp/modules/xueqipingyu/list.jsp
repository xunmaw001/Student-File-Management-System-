...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">学期评语管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">学期评语列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">学期评语列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="xueqipingyuNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="评语标题" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        评语类型
                                        <div class="layui-input-inline">
                                            <select name="xueqipingyuTypesSelectSearch"  style="width: 150px;" id="xueqipingyuTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //评语标题
            var xueqipingyuNameSearchInput = $('#xueqipingyuNameSearch');
            if( xueqipingyuNameSearchInput != null){
                if (xueqipingyuNameSearchInput.val() != null && xueqipingyuNameSearchInput.val() != '') {
                    searchForm.xueqipingyuName = $('#xueqipingyuNameSearch').val();
                }
            }
     
                //评语类型
            var xueqipingyuTypesSelectSearchInput = document.getElementById("xueqipingyuTypesSelectSearch");
            if(xueqipingyuTypesSelectSearchInput != null){
                var xueqipingyuTypesIndex = xueqipingyuTypesSelectSearchInput.selectedIndex;
                if( xueqipingyuTypesIndex  != 0){
                    searchForm.xueqipingyuTypes= document.getElementById("xueqipingyuTypesSelectSearch").options[xueqipingyuTypesIndex].value;
                }
            }
                                getDataList();
        }
        ...
        function getDataList() {
            http("xueqipingyu/page", "GET", {
                ...
                xueqipingyuDelete: 1,
                //本表的
                xueqipingyuName: searchForm.xueqipingyuName,
                xueqipingyuTypes: searchForm.xueqipingyuTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //评语标题
            var xueqipingyuNameCell = document.createElement('td');
            xueqipingyuNameCell.innerHTML = item.xueqipingyuName;
            row.appendChild(xueqipingyuNameCell);


            //评语类型
            var xueqipingyuTypesCell = document.createElement('td');
            xueqipingyuTypesCell.innerHTML = item.xueqipingyuValue;
            row.appendChild(xueqipingyuTypesCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("xueqipingyu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addxueqipingyu", "addxueqipingyu");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function xueqipingyuTypesSelectSearch() {
            var xueqipingyuTypesSelectSearch = document.getElementById('xueqipingyuTypesSelectSearch');
            if(xueqipingyuTypesSelectSearch != null) {
                xueqipingyuTypesSelectSearch.add(new Option('-请选择-',''));
                if (xueqipingyuTypesOptions != null && xueqipingyuTypesOptions.length > 0){
                    for (var i = 0; i < xueqipingyuTypesOptions.length; i++) {
                            xueqipingyuTypesSelectSearch.add(new Option(xueqipingyuTypesOptions[i].indexName,xueqipingyuTypesOptions[i].codeIndex));
                    }
                }
            }
        }
