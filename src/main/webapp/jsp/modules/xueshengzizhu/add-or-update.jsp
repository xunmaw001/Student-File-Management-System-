    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑资助记录</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">资助记录管理</li>
                        <li class="breadcrumb-item active">编辑资助记录</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">资助记录信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6 xueshengzizhuTextDiv">
                                        <label>详情</label>
                                        <textarea style="width: 450px"  id="xueshengzizhuText" name="xueshengzizhuText" class="form-control"placeholder="详情"></textarea>
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                xueshengzizhuText: "required",
            },
            messages: {
                yonghuId: "学生不能为空",
                xueshengzizhuName: "标题不能为空",
                xueshengzizhuJine: "资助金额不能为空",
                xueshengzizhuText: "详情不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#xueshengzizhuText").val(ruleForm.xueshengzizhuText);
