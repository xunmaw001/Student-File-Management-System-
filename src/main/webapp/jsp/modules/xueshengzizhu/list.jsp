...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">资助记录管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">资助记录列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">资助记录列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //详情
            var xueshengzizhuTextCell = document.createElement('td');
            xueshengzizhuTextCell.innerHTML = item.xueshengzizhuText;
            row.appendChild(xueshengzizhuTextCell);
